...
<style>
  ...
  * { box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
  ...
  .hand-card.playable:hover { transform: translateY(-6px); outline: 2px solid var(--gold-bright); outline-offset: -2px; }
  ...
  .hand-card.selected-for-reveal { outline: 3px solid var(--gold-bright); outline-offset: -3px; transform: translateY(-4px); }
  ...
  @media (min-width: 600px) {
    ...
    .hand-card .hc-rank { font-size: 16px; }
    .hand-card .hc-suit-big { font-size: 26px; }
