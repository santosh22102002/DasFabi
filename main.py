...
<style>
  :root {
    ...
    --card-width: clamp(42px, 11vw, 72px);
    --card-height: calc(var(--card-width) * 1.4);
    --seat-size: clamp(44px, 12vw, 64px);
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; -webkit-tap-highlight-color: transparent; }
  ...
  .mendi-strip { display: flex; gap: 3px; margin-top: 4px; height: 22px; flex-wrap: wrap; justify-content: center; }
  .mendi-mini {
  ...
  @media (min-width: 600px) {
    :root { --card-width: 64px; }
    .seat-marker.left { left: 8%; }
    .seat-marker.right { right: 8%; }
  }
  @media (max-height: 600px) {
    .score-cluster { min-height: 52px; padding: 4px 10px; }
    .hand-strip { min-height: calc(var(--card-height) + 10px); padding-bottom: 8px; }
  }
</style>
</head>
<body>
